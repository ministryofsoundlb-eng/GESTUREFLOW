...
const Carousel: React.FC<CarouselProps> = ({ rotation, selectedIndex, items }) => {
  ...
  return (
    <div className="relative w-full h-full perspective-1000 flex items-center justify-center overflow-hidden">
      <div 
